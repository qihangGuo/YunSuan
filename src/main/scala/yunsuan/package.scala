...
package object yunsuan {
  ...
  object VialuFixType {
    ...
    def vzext_vf2   = LiteralCat(FMT.VF2  , UINT, VialuOpcode.vext)   // "b00_0_100000".U(OpTypeWidth.W) // vext
    def vsext_vf2   = LiteralCat(FMT.VF2  , SINT, VialuOpcode.vext)   // "b00_1_100000".U(OpTypeWidth.W) // vext
    def vzext_vf4   = LiteralCat(FMT.VF4  , UINT, VialuOpcode.vext)   // "b01_0_100000".U(OpTypeWidth.W) // vext
    def vsext_vf4   = LiteralCat(FMT.VF4  , SINT, VialuOpcode.vext)   // "b01_1_100000".U(OpTypeWidth.W) // vext
    def vzext_vf8   = LiteralCat(FMT.VF8  , UINT, VialuOpcode.vext)   // "b10_0_100000".U(OpTypeWidth.W) // vext
    def vsext_vf8   = LiteralCat(FMT.VF8  , SINT, VialuOpcode.vext)   // "b10_1_100000".U(OpTypeWidth.W) // vext
    ...
    def vmsbc_vvm   = LiteralCat(FMT.VVMM , UINT, VialuOpcode.vmsbc)  // "b01_0_010100".U(OpTypeWidth.W) // vmsbc
    def vmsbc_vv    = LiteralCat(FMT.VVM  , UINT, VialuOpcode.vmsbc)  // "b10_0_010100".U(OpTypeWidth.W) // vmsbc
    ...
    def vsll_vv     = LiteralCat(FMT.VVV  , UINT, VialuOpcode.vsll)   // "b00_0_101001".U(OpTypeWidth.W) // vsll
    def vsrl_vv     = LiteralCat(FMT.VVV  , UINT, VialuOpcode.vsrl)   // "b00_0_101010".U(OpTypeWidth.W) // vsrl
    def vsra_vv     = LiteralCat(FMT.VVV  , SINT, VialuOpcode.vsra)   // "b00_1_101011".U(OpTypeWidth.W) // vsra
    def vnsrl_wv    = LiteralCat(FMT.WVV  , UINT, VialuOpcode.vsrl)   // "b11_0_101010".U(OpTypeWidth.W) // vsrl
    def vnsra_wv    = LiteralCat(FMT.WVV  , SINT, VialuOpcode.vsra)   // "b11_1_101011".U(OpTypeWidth.W) // vsra
    ...
    def vssrl_vv    = LiteralCat(FMT.VVV  , UINT, VialuOpcode.vssrl)  // "b00_0_101100".U(OpTypeWidth.W) // vssrl
    def vssra_vv    = LiteralCat(FMT.VVV  , SINT, VialuOpcode.vssra)  // "b00_1_101101".U(OpTypeWidth.W) // vssra
    def vnclipu_wv  = LiteralCat(FMT.WVV  , UINT, VialuOpcode.vssrl)  // "b11_0_101100".U(OpTypeWidth.W) // vssrl
    ...
    def vmxnor_mm   = LiteralCat(FMT.MMM  , UINT, VialuOpcode.vxnor)  // "b11_0_101000".U(OpTypeWidth.W) // vxnor
    // Zvbb
